...
export const mentorDetailedWorkPlacePageSlice = createSlice({
  name: "mentorDetailedWorkPlacePageSlice",
  initialState,
  reducers: {
...
export const {
  actions: mentorDetailedWorkPlacePageActions,
  reducer: mentorDetailedWorkPlacePageReducer,
} = mentorDetailedWorkPlacePageSlice;
